# -*- coding: utf-8 -*-
"""Asma_Abdiwali_TP085093_CP2.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1XAIyYUa1jW1c7-IsEpRIAuRLbjdcz-52
"""
...
wb_exchange = pd.read_csv('/content/drive/MyDrive/CP Dataset/exchange rate.csv')
food_data = pd.read_csv('/content/drive/MyDrive/CP Dataset/wfp_food_prices_som.csv')
...
if 'alerts_df' in locals():
    ...
    files.download('somalia_food_price_alerts.csv')
...
if 'alerts_df' in locals():
    ...
    files.download('somalia_crisis_alerts.csv')
...
if 'alerts_df' in locals() and 'region_name' in alerts_df.columns:
    ...
    files.download('somalia_regional_alert_summary.csv')
...
if 'alerts_df' in locals():
    ...
    files.download('somalia_commodity_risk_analysis.csv')
...
if 'robust_thresholds' in locals():
    ...
    files.download('somalia_primary_thresholds.csv')
    ...
    files.download('somalia_secondary_thresholds.csv')
...
files.download('commodity_mappings.csv')
...
files.download('market_mappings.csv')
...
if 'district_region_map' in locals():
    ...
    files.download('district_region_mappings.csv')
...
if 'health_report' in locals():
    ...
    files.download('system_health_report.csv')
...
def load_deployment_data():
    ...
    try:
        ...
        base_path = '/content/drive/MyDrive/CP Dataset/'
